...
urlpatterns = [
    ...
    path('order-item/<uuid:order_id>/request-cancel/', views.request_cancel_order_item, name='request_cancel_order_item'),
    ...
    path("order/cancel/<uuid:order_id>/", views.cancel_order_page, name="cancel_order_page"),
    ...
    path('cancellation/<uuid:order_id>/<str:action>/', views.admin_approve_reject_cancellation, name='admin_approve_reject_cancellation'),
